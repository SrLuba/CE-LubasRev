...
public partial class Global {
	...
	public static void InitMainWindow(Options options) {
		...
		if (!fullscreen) {
			window = new RenderWindow(new VideoMode(windowW, windowH), "MMX Online Deathmatch - Luba Rev");
			...
			window = new RenderWindow(new VideoMode(desktopWidth, desktopHeight), "MMX Online Deathmatch - Luba Rev", Styles.Fullscreen);
