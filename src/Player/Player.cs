...
public partial class Player {
	...
	public Texture discord_avatar_texture;
	...
	public void syncFromServerPlayer(ServerPlayer serverPlayer) {
		...
		avatarID = serverPlayer.avatarURL;
	...
	public byte[] localAvatarDownload;
	public void update() {
		...
		if (isMainPlayer) this.avatarID = Utilities.SDKDiscord.localAvatar;
